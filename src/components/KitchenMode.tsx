...
export function KitchenMode({ recipe, onClose }: KitchenModeProps) {
  ...
  const printRecipe = () => {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>${recipe.title} - Kitchen Instructions</title>
          <style>
        ...
        <body>
          <h1>${recipe.title}</h1>
          <div class="meta">Time: ${recipe.time} | Yield: ${recipe.servings} Guests</div>
        ...
        <aside className="w-80 bg-zinc-900/50 border-r-4 border-brand-gold/30 overflow-y-auto no-scrollbar hidden md:block">
           <div className="p-8 space-y-4">
              ...
              {recipe.instructions.map((_, i) => (
                ...
                >
                  <span className="text-2xl font-black font-mono">0{i + 1}</span>
